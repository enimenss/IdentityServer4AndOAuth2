       ...
       // private readonly RoleManager<AppRole> _roleManager;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Restaurant restaurantRepo = new Restaurant
                {
                    Date = DateTime.Now,
                    City = Input.City,
                    ...
                    Status = 0,
                    RestaurantId = Input.Email
                    

                };
                _repoWrapper.Restaurant.Create(restaurantRepo);
                _repoWrapper.User.CreateUser(userRepo);
                _repoWrapper.Save();
